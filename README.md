...
Each release keeps its own folder under `demo/`. Everything from v2.0 on is shot
...
captured headlessly by `scripts/demo/shoot.mjs` — so nobody's real transcripts
appear in the repo. The dark (Midnight) theme is shown; every v2.0 image has a
`-light` twin (Paper) next to it.
...
<table>
  <tr>
    <td width="50%"><img src="demo/v2.0/home-activity-dark.png" alt="Home · Activity"><br><sub><b>Home · Activity</b> — running terminals, the latest sessions across every provider and folder, pinned items, recent projects and the keyboard map.</sub></td>
    <td width="50%"><img src="demo/v2.0/quick-switcher-open-dark.png" alt="Ctrl+K quick switcher"><br><sub><b>Ctrl+K</b> — fuzzy-jump to any project or session in any provider; Enter opens it, Ctrl+Enter opens it in a new tab.</sub></td>
  </tr>
  <tr>
    <td><img src="demo/v2.0/sidebar-workspaces-pinned-dark.png" alt="One sidebar: folder chips, a cross-provider workspace, pinned rows"><br><sub><b>One sidebar</b> — colour-coded folder chips, a workspace grouping the same repo under Claude Code and Codex, pinned projects and sessions.</sub></td>
    <td><img src="demo/v2.0/session-conversation-dark.png" alt="A Claude Code session with an inline sub-agent thread"><br><sub><b>Conversation</b> — every tool call with its input and output; a sub-agent expands inline under the call that spawned it.</sub></td>
  </tr>
  <tr>
    <td><img src="demo/v2.0/session-codex-dark.png" alt="An OpenAI Codex session"><br><sub><b>Same screens for Codex</b> — shell / apply_patch calls, reasoning, rate-limit and context meters.</sub></td>
    <td><img src="demo/v2.0/insights-dark.png" alt="Insights"><br><sub><b>Insights</b> — your own rhythm: hour of day, weekday, streaks, session shape, neglected projects.</sub></td>
  </tr>
  <tr>
    <td colspan="2"><img src="demo/v2.0/stats-dark.png" alt="Stats"><br><sub><b>Stats</b> — tokens, tools and models per tracked folder, drillable to project and session.</sub></td>
  </tr>
</table>
