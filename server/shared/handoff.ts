...
export function composeBrief({ need, providerLabel, kind, filePath, content, docs, cwd, docsIndex = null, kinds = null }: BriefContext) {
  ...
  lines.push(
    ...
    '3. Once you understand the intent, look for skills that serve it: use the find-skills skill in this project (skills/find-skills) or `npx skills find <query>` with what I am trying to do, and propose the matches — what each would add and whether I want it — before configuring anything by hand.',
