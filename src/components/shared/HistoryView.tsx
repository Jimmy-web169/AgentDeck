...
export default function HistoryView({ data }: { data?: import('../../api/models.ts').HistoryReport | null }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-6">
      ...
      <div className="space-y-1.5">
        {items.map((h, i) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: Provider history has no native row ID; these rows have no local state or stateful children.
